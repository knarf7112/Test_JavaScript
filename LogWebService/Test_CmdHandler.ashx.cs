...
namespace LogWebService
{
    ...
    /// CmdHandler 的摘要描述
    /// </summary>
    public class Test_CmdHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            using (StreamReader sr = new StreamReader(context.Request.InputStream, Encoding.UTF8))
            {
                ...
                //dynamic dd = JsonConvert.DeserializeObject(datastr);
            }
            ...
            else if (!String.IsNullOrEmpty(cmd) && cmd == "get log")
            {
                IList<LogDO> logList = Global.logDumper.Operate();
                string data = JsonConvert.SerializeObject(logList);
